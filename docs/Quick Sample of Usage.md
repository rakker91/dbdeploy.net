The easiest way to get started with DbDeploy is to simply download the NuGet package from [http://nuget.org/packages/DbDeployNet2/](http://nuget.org/packages/DbDeployNet2/)
